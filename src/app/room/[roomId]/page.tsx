...
const Page = () => {
  ...
  const [timeRemaining, setTimeRemaining] = useState<number | null>(21);
    ...
    <main className="flex flex-col h-screen max-h-screen overflow-hidden">
      ...
      <div className="p-4 border-t border-zinc-800 bg-zinc-900/30">
        <div className="flex gap-4">
          ...
          <button className="bg-zinc-800 text-zinc-400 px-6 text-sm font-bold hover:text-zinc-200 transtion-all disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer">
            SEND
          </button>
        </div>
      </div>
